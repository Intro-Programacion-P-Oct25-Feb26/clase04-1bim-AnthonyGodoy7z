...
public class Ejemplo11 {
    ...
    public static void main(String[] args) {
        ...
        nombreAsignatura1 = entrada.nextLine(); //nextLine perimite recibir una cadena
        System.out.println("Ingrese nota de asignatura 1");
        notaAsignatura1 = entrada.nextDouble();
        
        // %.2f significa que se va a representar un decimal y el numero la cantidad de deciamles que habran
